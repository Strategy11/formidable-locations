	...
	<div id="poststuff" class="metabox-holder">
		<div id="post-body">
			<div id="post-body-content">
				<div class="postbox ">
					<h3 class="hndle"><span><?php esc_html_e( 'Importing Locations', 'formidable-locations' ); ?></span></h3>
					<div class="inside">
						<div class="with_frm_style" id="frm_import_message"><span class="frm_message" style="padding:7px;"><?php printf( esc_html__( '%1$s entries are importing', 'formidable-locations' ), '<span class="frm_csv_remaining">' . absint( $remaining ) . '</span>' ); ?></span></div>
